...
class ConsumerRegistrationScreen extends StatefulWidget {
  ...
  const ConsumerRegistrationScreen({super.key, required this.onBack});
...
class _ConsumerRegistrationScreenState
  ...
  Future<void> _register() async {
    ...
    final success = await auth.consumerRegister(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text(auth.isLoading ? 'Creating...' : 'Create Account'),
                      ),
                    ),
                  ],
                );
